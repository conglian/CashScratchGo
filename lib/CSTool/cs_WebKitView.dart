...
class CSWebkitview extends StatefulWidget {
  final String url;
  final String title;

  const CSWebkitview({super.key, required this.url, required this.title});

  @override
  State<CSWebkitview> createState() => _CSWebkitviewState();
}

class _CSWebkitviewState extends State<CSWebkitview> {
  late final WebViewController _controller;
  final String TAG = "CSWebkitview";
