...
class CSImg extends StatelessWidget {
  final String name;
  final double? width;
  final double? height;
  final double? size;
...
DecorationImage CSDImg(String name, {BoxFit fit = BoxFit.fill}) {
  var p = "$name".image();
...
class CSBouncyImage extends StatefulWidget {
  ...
  @override
  State<CSBouncyImage> createState() => _CSBouncyImageState();
}

class _CSBouncyImageState extends State<CSBouncyImage>
  ...
  @override
  void didUpdateWidget(covariant CSBouncyImage oldWidget) {
...
class CSAnimatedImageMove extends StatefulWidget {
  ...
  @override
  _CSAnimatedImageMoveState createState() => _CSAnimatedImageMoveState();
}

class _CSAnimatedImageMoveState extends State<CSAnimatedImageMove>
    with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant CSAnimatedImageMove oldWidget) {
    super.didUpdateWidget(oldWidget);
        ...
        return Transform.translate(
          ...
          child: Transform.scale(
            ...
            child: SizedBox(
              width: widget.ws,
              height: widget.hs,
              child: CSImg(name: widget.imageUrl),
            ),
          ),
        );
      },
