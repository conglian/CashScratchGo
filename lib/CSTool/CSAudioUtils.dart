...
class CSAudioUtils {
  // 单例实例
  static final CSAudioUtils _instance = CSAudioUtils._internal();

  factory CSAudioUtils() => _instance;

  CSAudioUtils._internal();
  ...
  Future<void> playBGM({double volume = 0.6}) async {
    ...
    if(_bgmPlayer.state == PlayerState.stopped){
      ...
      await _bgmPlayer.play(AssetSource("cs_bg".mp3files()));
