...
class CSGradientText extends StatelessWidget {
  final String text;
...
class CSGradientStrokeText extends StatelessWidget {
  final String text;
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: _CSGradientStrokeTextPainter(
          text: text,
...
class _CSGradientStrokeTextPainter extends CustomPainter {
  final String text;
  final List<Color> gradientColors;
  final Color strokeColor;
  final double strokeWidth;
